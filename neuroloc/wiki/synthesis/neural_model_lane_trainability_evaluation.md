...
implement the local tiny mirror for the first narrow learned-codec target, while keeping oracle compression bounds and family-specific controls ahead of any full-model path.
