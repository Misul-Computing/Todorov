...
1. compression under bit budget, because the task directly tests the compression claim. proof package: [[neural_model_dossier_compression_under_bit_budget_codec]]. local mirror contract: [[neural_model_tiny_mirror_contract_compression_under_bit_budget]].
