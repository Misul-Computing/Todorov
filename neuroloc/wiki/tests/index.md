...
- [[tests/compression_under_bit_budget_mirror|compression under bit budget mirror]] -- first local dataset, forbidden-input guard, baseline-control, bit-accounting, and telemetry surface for the accepted compression-under-bit-budget tiny mirror
